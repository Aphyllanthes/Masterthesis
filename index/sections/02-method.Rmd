...
Die Radien 1000m und 2000m werden verwendet, um das größere Umfeld um den Standort zu kategorisieren. Ist der Standort im größeren Umfeld von einem großen Anteil versiegelter Fläche umgeben, so kann dies als Indikator für die Habitatvernetzung und die Lage des Nisthilfenstandortes innerhalb des städtischen Bereichs dienen.
...
* Die Landnutzungsklassen: für alle Kategorien wurde ihre Fläche im 500m-Radius um die Nisthilfenstandorte berechnet. Kategorien, welche nur in unter 10% der Nisthilfenstandorte vorkommen, wurden nicht für die Modellierung verwendet. Es blieben somit die Landnutzungsklassen "Stadt" (Industrielle Flächen sowie Wohngebiete), "Wald", "Ackerland" und "Weideflächen".
  ...
  + Index 2 für die Komplexität der Landschaft: die Summe der Kantenlänge (Edgelength)  aller Polygone der Landnutzungsklassen im 500m Radius. Die Kantenlänge ist gleich der Kantendichte (Edge-density) da die Fläche aller 500-Radius-Buffer um die Nisthilfenstandorte identisch ist. Die Außenkanten der Flächen im gepufferten Bereich werden nicht miteinberechnet.
 
(ref:karte1) Die Karte zeigt einen Beispielausschnitt mit drei Nisthilfenstandorten in Freiburg. Für jeden der abgebildeten Buffer mit den Radien 100m,  250m, 500m, 1000m und 2000m um die Nisthilfenstandorte wurde der Mittelwert der versiegelten Fläche berechnet. Hierzu wurden die dargestellten Rasterdaten des Versiegelungsgrades verwendet. Pixel mit dem Wert Null sind in der Abbildung transparent dargestellt, sodass die Openstreetmap-Basiskarte dort sichtbar ist, wo die Fläche unversiegelt ist. \label{karte}
