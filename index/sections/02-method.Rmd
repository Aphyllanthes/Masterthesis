...
Modellselektion erfolgte hier anhand AIC und Anova. Modelle mit um mehr als zwei Einheiten höherem AIC im Vergleich zum niedrigsten AIC aller Modelle wurden ausgeschlossen [@burnham2002h]. Zeigt die Anova signifikante Unterschiede zwischen zwei Modellen, wird das komplexere Modell (mit größerer Anzahl an Prädiktoren) ausgewählt. Andernfalls wird das einfachere Modell verwendet. Das somit ausgewählte Modell wird anhand der Residuendiagnostik nach @DHARMa evaluiert.
...
Mithilfe des Paketes 'bipartite' [@bipartite] wurden die Wirt-Parasitoid-Beziehungen dargestellt und die das Netzwerk beschreibenden Indizes "H2'", "generality" und "vulneratbility" mithilfe der Funktion $networklevel()$  berechnet. Die Indizes dienen zum Vergleich des Grades der Spezialisierung der natürlichen Gegenspieler und Wirtsbienen zwischen Land und Stadt.
