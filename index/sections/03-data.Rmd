...
names(Artliste_IH19) <- c("Wirtsbienen", "natürliche Gegenspieler", "natürliche Gegenspieler - Zuordnung zu Wirt anhand Morphotyp des Wirtes")
...
####  Artenzahl der Bienen in Abhängigkeit des Versiegelungsgrades
...
#### Abundanz der Wildbienen in Abhängigkeit vorhandenen Insektenhäusern:
