...
Im mittel waren zwei Bienenarten in einer Nisthilfe, die maximale Bienenartenzahl in einer Nisthilfe betrug sieben Arten. Der Mittelwert der Abundanz waren 72 Brutzellen pro Nisthilfe, 844 Brutzellen war das Maximum an Brutzellen in einer Nisthilfe. Histogramme von Artenzahl und Abundanz der Wildbienen sind im Anhang \@ref(app1) in Abbildung \ref{deskriptiv} dargestellt.
...
(ref:lonelytab) Auflistung der Arten, welche nur in einer Nisthilfe vorkamen, mit der Information wiviele Nester in der Nisthilfe belegt waren ('Nests') und dem mittleren Versiegelungsgrad in % im 500m-Radius der besiedelten Nisthilfe ('imp 500'. \label{lonely_species} 
...
Dieses Modell kann durch die Erweiterung um die Prädiktoren des mittleren Versiegelungsgrades als linearen sowie quadratischen Term nicht verbessert werden. Dies gilt für alle Radien, für den der mittlere Versiegelungsgrad berechnet wurde. Der AIC dieser Modelle im Vergleich zum einfacheren Modell ohne den Versiegelungsgrad als Prädiktor ist jeweils nicht mehr als 2 Einheiten unterschiedlich.    
...
Nur der Versiegelungsgrad im 250 m Radius verbessert das Model. Behält man den Versiegelungsgrad im Modell, so verbessert das  das “Insektenhaus” das Modell nicht. Dies gilt für alle Radien.
...
gridExtra::grid.arrange(p1ep, p2pm, p3pm,
                        heights=c(grid::unit(5, "in"), grid::unit(5.5, "in")),
                        layout_matrix = hmat)
